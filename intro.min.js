...
!(function (t, e) {
    ...
    it = r(function (t) {
      ...
      (t.exports = function (t, e, o, r) {
        var l,
          ...
          u = !!r && !!r.noTargetGet;
        'function' == typeof o &&
          ('string' != typeof e || S(o, 'name') || O(o, 'name', e),
          (l = n(o)).source ||
    ...
    Ot = function (t, e) {
      ...
      if ((n = c ? a : u ? a[s] || L(s, {}) : (a[s] || {}).prototype))
        for (i in e) {
          if (
            ((r = e[i]),
            (o = t.noTargetGet ? (l = Pt(n, i)) && l.value : n[i]),
  ...
  var Zt = Gt && +Gt,
    ...
    re = function (t) {
      return (
        (S(ne, t) && (te || 'string' == typeof ne[t])) ||
          (te && S(ie, t) ? (ne[t] = ie[t]) : (ne[t] = oe('Symbol.' + t))),
        ne[t]
      );
    },
    le = re('species'),
      ...
      if (
        ...
        var a = /./[o],
          c = n(
            ...
            {
              REPLACE_KEEPS_$0: se,
              REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE: ue,
            },
          ),
          u = c[0],
          h = c[1];
    ...
    return [
      ...
      function (t) {
        ...
        for (var a, s = [], c = 0; null !== (a = me(o, r)); ) {
          var u = String(a[0]);
          (s[c] = u),
            '' === u && (o.lastIndex = ge(r, ht(o.lastIndex), l)),
            c++;
        }
        return 0 === c ? null : s;
      },
        ...
        [
          ...
          function (t, o) {
            ...
            for (var p = 0, d = 0, g = []; d < a.length; ) {
              ...
              if (
                null === v ||
                (m = Fe(ht(h.lastIndex + (ze ? 0 : d)), a.length)) === p
              )
                d = ge(a, d, c);
              else {
                if ((g.push(a.slice(p, d)), g.length === f)) return g;
                for (var b = 1; b <= v.length - 1; b++)
                  if ((g.push(v[b]), g.length === f)) return g;
                d = p = m;
              }
            }
  ...
  var Qe =
    ...
    tn =
      ...
      s(function () {
        ...
        ? function (t, e) {
            for (
              var n = be(t), i = arguments.length, o = 1, r = xt.f, l = f.f;
              i > o;
  ...
  function nn(t) {
    var e = t.parentNode;
    return (
      !(!e || 'HTML' === e.nodeName) && ('fixed' === We(t, 'position') || nn(e))
    );
  }
  Ot(
  ...
  function pn(t) {
    if (t) {
      ...
      nn(e.element)
        ? Ve(t, 'introjs-fixedTooltip')
        : hn(t, 'introjs-fixedTooltip'),
    ...
    return [
      ...
      function (t, i) {
        ...
        for (var g, m = '', v = 0, b = 0; b < p.length; b++) {
          ...
          for (
            var y = String(d[0]),
              w = cn(un(ct(d.index), c.length), 0),
              _ = [],
              x = 1;
            x < d.length;
            x++
          )
            _.push(void 0 === (g = d[x]) ? g : String(g));
          var S = d.groups;
          if (u) {
  ...
  var dn,
    gn = c
      ...
      : function (t, e) {
          T(t);
          for (var n, i = Qe(e), o = i.length, r = 0; o > r; )
            P.f(t, (n = i[r++]), e[n]);
          return t;
        },
    ...
    { target: 'Array', proto: !0, forced: !En },
    {
      slice: function (t, e) {
        ...
        if (
          ...
          (n !== Array && !ve(n.prototype))
            ? w(n) && null === (n = n[An]) && (n = void 0)
            : (n = void 0),
          n === Array || void 0 === n)
        )
          return kn.call(r, a, s);
        for (
          i = new (void 0 === n ? Array : n)(Nn(s - a, 0)), o = 0;
          a < s;
          a++, o++
        )
          a in r && ye(i, o, r[a]);
  ...
  function Wn(t, e, n) {
    var i = this._options.positionPrecedence.slice(),
      ...
      s = 'floating';
    a.bottom + r > o.height && Vn(i, 'bottom'),
      a.top - r < 0 && Vn(i, 'top'),
      a.right + l > o.width && Vn(i, 'right'),
      a.left - l < 0 && Vn(i, 'left');
    var c,
      u,
  ...
  function Jn() {
    ...
    null === t &&
      ((t = Xn('div', { className: 'introjs-disableInteraction' })),
      ...
      (r = s.querySelector('.introjs-skipbutton')),
        ...
        (l._lastShowElementTimer = window.setTimeout(function () {
          null !== u &&
            ...
            ).style.cssText = 'width:'.concat(Qn.call(l), '%;')),
            s
              .querySelector('.introjs-progress .introjs-progressbar')
              .setAttribute('aria-valuenow', Qn.call(l)),
            (d.style.opacity = 1),
  ...
  function bi(t) {
    ...
    di.call(this),
      i.on(document, 'click', vi, this, !1),
      i.on(window, 'resize', yi, this, !0);
  }
  function yi() {
    var t = this;
    ...
    if (this._options.steps)
      n(this._options.steps, function (t) {
        ...
        if (
          ...
          null === n &&
            ((n = Xn('div', { className: 'introjsFloatingElement' })),
    ...
    return (
      ...
      ji.call(this, t) &&
        ...
        this._options.keyboardNavigation &&
          i.on(window, 'keydown', ri, this, !0),
        i.on(window, 'resize', _i, this, !0)),
      !1
    );
  }
  Ot(
      ...
      splice: function (t, e) {
        ...
        if (
          (0 === h
            ...
            : 1 === h
            ? ((n = 0), (i = c - u))
            : ((n = h - 2), (i = zn(Fn(ct(e), 0), c - u))),
          c + n - i > 9007199254740991)
        )
          throw TypeError('Maximum allowed length exceeded');
        for (o = _e(s, i), r = 0; r < i; r++)
          (l = u + r) in s && ye(o, r, s[l]);
        if (((o.length = i), n < i)) {
          for (r = u; r < c - i; r++)
